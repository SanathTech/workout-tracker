...
const SESSIONS = [
  ...
  },
  {
    ...
    exercises: [
      ...
      { name: 'Weighted Dips', sets: 3, repLow: 6, repHigh: 8, rir: [1, 1, 1], rest: 150, warmup: [1, 2], main: true,
  ...
  },
  {
    ...
    exercises: [
      ...
      { name: 'Incline DB Press', sets: 3, repLow: 6, repHigh: 10, rir: [1, 1, 1], rest: 150, warmup: [1, 2], main: true,
