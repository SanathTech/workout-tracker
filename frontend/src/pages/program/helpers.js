import { formatRestRange } from '../../util/format';

export const dashedAddBtn = 'w-full text-center py-2 min-h-11 md:min-h-0 text-sm text-neutral-400 hover:text-neutral-200 border border-dashed border-neutral-800 rounded hover:bg-neutral-900 transition-colors';
export const iconBtn = 'text-neutral-400 hover:text-neutral-200 w-11 h-11 flex items-center justify-center rounded shrink-0';
